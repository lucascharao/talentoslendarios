        ...
        {title && (
            <div className="bg-[#252526] px-4 py-2 border-b border-[#3e3e42] text-xs font-mono text-[#858585] flex items-center justify-between">
                <div className="flex items-center gap-2">
                     <Icon name="sparkles" size="size-3" className="text-brand-gold" />
                     {title}
                </div>
                <span className="opacity-0 group-hover:opacity-100 transition-opacity text-[10px] uppercase font-bold tracking-wider text-brand-gold select-none">Copy Content</span>
            </div>
        )}
        ...
        <TabsContent value="cursor" className="space-y-8 animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <CodeBlock title=".cursorrules">
{`# ACADEMIA LENDÁRIA DESIGN SYSTEM INSTRUCTIONS
...
{`Act as a Senior Frontend Engineer and Design System Specialist for Academia Lendária.
...
`}
                 ...
                 <div className="space-y-6">
                     <Alert variant="info">
                        ...
                        <AlertTitle>Dica para Gemini 1.5 Pro</AlertTitle>
                        <AlertDescription className="text-xs">
                            O Gemini tem uma janela de contexto enorme. Você pode colar o conteúdo inteiro do arquivo <code>types.ts</code> e <code>index.html</code> (variáveis CSS) junto com o prompt para ele entender exatamente as cores disponíveis.
                        </AlertDescription>
                    </Alert>
                 </div>
             </div>
