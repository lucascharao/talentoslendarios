...
const ToneSlider: React.FC<{ left: string; right: string; value: number; description: string }> = ({ left, right, value, description }) => (
  <div className="space-y-2">
    ...
    <p className="text-xs text-muted-foreground text-center font-serif italic">{description}</p>
  </div>
);
  ...
  return (
    <div className="space-y-16 animate-fade-in">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-card to-muted p-6 md:p-10 border border-border">
         ...
         <p className="font-serif text-lg md:text-xl text-muted-foreground max-w-3xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <h4 className="text-xl font-bold flex items-center gap-2"><Icon name="crown" className="text-brand-gold" /> 15 Atributos do Líder</h4>
                ...
                <div className="space-y-3 h-[500px] overflow-y-auto pr-2 custom-scrollbar">
                    {[
                        ...
                        <div key={i} className="p-4 border border-border rounded-lg bg-card hover:border-primary/50 transition-colors group">
                            ...
                            <p className="text-xs text-muted-foreground font-serif mt-1">{attr.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
                ...
                <Card>
                    ...
                    <CardContent className="space-y-6">
                         <div>
                            ...
                            <p className="text-xs italic text-muted-foreground border-l-2 border-primary pl-3">"Este é um chamado aos inconformados. Àqueles que desafiam as tradições. Estes são os lendários."</p>
                        </div>
                         <div>
                            <p className="text-sm font-bold mb-2 flex items-center gap-2"><Icon name="briefcase" size="size-3" /> Profissional-Direto (Interno)</p>
                            <p className="text-xs italic text-muted-foreground border-l-2 border-primary pl-3">"Líderes erram rápido, barato e diferente. Cultura lendária é inegociável."</p>
                        </div>
                         <div>
                            <p className="text-sm font-bold mb-2 flex items-center gap-2"><Icon name="lightning" size="size-3" /> Informal-Intenso (Chat)</p>
                            <p className="text-xs italic text-muted-foreground border-l-2 border-primary pl-3">"Usa IA, porra! Antes de contratar, pergunta: dá pra automatizar isso?"</p>
                        </div>
                    </CardContent>
                </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
             {[
                 ...
                 <div key={i} className="p-6 bg-card border border-border rounded-xl hover:border-primary/50 transition-colors group">
                     ...
                     <p className="text-xs text-muted-foreground font-serif leading-snug">{item.desc}</p>
                 </div>
             ))}
        </div>
                    ...
                    {[
                        ...
                        <div key={i} className="flex items-start gap-3 p-3 bg-background/50 rounded-lg border border-brand-blue/10">
                            ...
                            <div>
                                ...
                                <span className="text-xs text-muted-foreground font-serif">{item.desc}</span>
                            </div>
                        </div>
                    ))}
                </CardContent>
                 ...
                 <CardContent className="grid gap-4">
                    <div className="p-4 bg-background rounded-lg border border-brand-green/10 flex gap-4 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Sua missão de vida traduzida no negócio.</p>
                        </div>
                    </div>
                    <div className="p-4 bg-background rounded-lg border border-brand-green/10 flex gap-4 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Estratégias que educam usando suas zonas de genialidade.</p>
                        </div>
                    </div>
                    <div className="p-4 bg-background rounded-lg border border-brand-green/10 flex gap-4 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground font-serif">Um espaço onde as pessoas se sentem realizadas.</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
             ...
             <div className="relative z-10 space-y-6">
                 ...
                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-sm">
                     <div>
                         ...
                         <p className="font-serif opacity-80 leading-relaxed">Unir e potencializar pessoas lendárias com IA para imortalizar seu legado.</p>
                     </div>
                     <div>
                         <p className="font-bold mb-2 text-primary">ARQUÉTIPOS</p>
                         <p className="font-serif opacity-80">Rebelde + Mago + Sábio</p>
                     </div>
                 </div>

                 <div className="space-y-2">
                     <p className="font-bold text-sm text-primary">MANDAMENTOS DA COMUNICAÇÃO</p>
                     <ul className="space-y-1 text-sm font-serif opacity-80 grid grid-cols-1 sm:grid-cols-2 gap-x-4">
